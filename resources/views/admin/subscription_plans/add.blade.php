...
<section class="content">
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="{{ route('admin.add_plan') }}" method="post" id="add-plan" enctype="multipart/form-data">
            @csrf
                ...
                <!-- form start -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="{{ $type['type'] }}" name="features[{{ $type['name'] }}]" placeholder="{{ $type['placeholder'] }}" class="form-control {{ $type['class'] }}" required>
                        </div>
                        @endif
